...
static uint32_t colors[][3] = {
    /* fg (texto)   bg (fundo)   border (borda) */
    [SchemeNorm] = { 0xffffffff,  0x000000ff,  0x444444ff },
    [SchemeSel]  = { 0x000000ff,  0xdec9a0ff,  0xdec9a0ff },
    [SchemeUrg]  = { 0xffffffff,  0x000000ff,  0x770000ff },
};
...
static const Key keys[] = {
	...
	/* Navegação estilo Sway (focusdir) */
	...
	/* Mover janelas fisicamente (movestack) */
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Up,          movestack,        {.i = -1} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_Down,        movestack,        {.i = 1} },

	/* Controle de Gaps (Espaçamento) */
	{ MODKEY,                    XKB_KEY_minus,       incgaps,          {.i = -1} },
	{ MODKEY,                    XKB_KEY_equal,       incgaps,          {.i = +1} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_minus,       defaultgaps,      {0} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_equal,       togglegaps,       {0} },
